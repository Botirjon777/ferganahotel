...
export function Navbar() {
  ...
  return (
    <nav
      id="navbar"
      className="fixed top-0 left-0 right-0 h-[80px] md:h-[80px] max-md:h-[64px] z-1000 flex items-center justify-between px-5 md:px-12 transition-all duration-400 bg-cream/96 backdrop-blur-md shadow-[0_2px_30px_rgba(184,135,43,0.10)]"
    >
      <Logo />
