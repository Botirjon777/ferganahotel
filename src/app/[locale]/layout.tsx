...
const BASE = "https://ferganahotel.uz";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title: {
      default: "Fergana Hotel — Luxury Hotel in Fergana, Uzbekistan",
      template: "%s | Fergana Hotel",
    },
    description:
      "Experience genuine hospitality, premium rooms, and modern comfort in the heart of Fergana. Fergana Hotel — a place you will want to return to.",
    keywords: [
      "fergana hotel",
      "fergana hotel",
      "hotel fergana",
      ...
      "гостиница фергана",
      "фергана гостиница",
      "fergana mehmonxonasi",
      "best hotel in fergana",
      "luxury accommodation fergana",
      "гостиница в фергане",
      "отель фергана",
    ],
    authors: [{ name: "Fergana Hotel" }],
    creator: "Fergana Hotel",
    publisher: "Fergana Hotel",
    alternates: {
      languages: {
        uz: `${BASE}/uz${path}`,
        ru: `${BASE}/ru${path}`,
