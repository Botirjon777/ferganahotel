...
export function ReviewCard({ review, locale }: ReviewCardProps) {
  ...
  return (
    <div className="bg-white border border-sand/30 p-2.5 md:p-5 rounded-lg flex flex-col gap-5 transition-all hover:border-gold/35 hover:shadow-[0_8px_30px_rgba(184,135,43,0.06)] shadow-[0_4px_20px_rgba(184,135,43,0.02)]">
      {/* Top Header */}
