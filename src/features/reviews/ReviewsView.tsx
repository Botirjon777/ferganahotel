...
function WriteReviewCTA() {
  ...
  const platforms = [
    {
      name: "Google Maps",
      href: "https://g.page/r/CcZVshSCrgGAEBM/review",
      Icon: SiGooglemaps,
      color: "#4285F4",
    },
    {
      name: "Yandex Maps",
      href: "https://yandex.uz/maps/org/151678975237/reviews?utm_source=qr&utm_medium=vizitka&utm_campaign=v2",
      Icon: FaYandex,
      color: "#FC3F1D",
    },
    {
      name: "Tripadvisor",
      href: "https://www.tripadvisor.com/UserReviewEdit-g788138-d23266096-Fergana_Hotel-Fergana_Fergana_Province.html",
      Icon: SiTripadvisor,
      color: "#34E0A1",
    },
  ];
